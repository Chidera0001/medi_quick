...
import 'package:medi_quick/consts/consts.dart';
        ...
        onPressed: () async {
          ...
          if (context.mounted) {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (BuildContext context) => SignIn(auth: FirebaseAuth.instance)
                )
            );
          }
        },
...
final List<Onboard> messageTiles = [
  Onboard(
      image: 'assets/images/image-medical-2.jpg',
  ...
  Onboard(
      image: 'assets/images/image-medical-3.jpg',
